...
function AppBase:testAppBaseFunction(...)
    print("testAppBaseFunction")
end
...
function AppBase:ctor(appName, packageRoot)
    ...
    print("My Name", appName)
    print("My Package Root", packageRoot)
...
function AppBase:enterScene(sceneName, args, transitionType, time, more)
    ...
    print("enter scenePackageName:", scenePackageName)
