...
namespace Fiskerspace{
class FiskerClass{
protected:
	int fclass;
public:
	static const uint32_t fclass_const = 0x778;
	virtual uint32_t getFiskerClassType(){
		return FiskerClass::fclass_const;
	}

	int aPublicFieldClassID;
